...
class MarkerBasics(object):
    def __init__(self):
        self.marker_objectlisher = rospy.Publisher('/Marker_basics',Marker,queue_size=1)
    ...
    def init_marker(self,index=0,z_val=0):
        ...
        self.marker_object.pose.orientation.x = 0.2
        self.marker_object.pose.orientation.y = 0.25
