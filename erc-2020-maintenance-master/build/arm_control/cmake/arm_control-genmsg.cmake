...
set(MSG_I_FLAGS "-Iarm_control:/home/apurba/arm/src/arm_control/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/apurba/arm/src/arm_control/msg/Efforts.msg" NAME_WE)
add_custom_target(_arm_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "arm_control" "/home/apurba/arm/src/arm_control/msg/Efforts.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(arm_control
  "/home/apurba/arm/src/arm_control/msg/Efforts.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/arm_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/arm_control\")")
  # install generated code
  install(
